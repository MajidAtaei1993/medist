<template>
    <section class="medist-auth-doctor">
            <div :class="steppers <3 ? 'body' : 'body-full '">
                <v-stepper v-model="steppers" alt-labels class="steppers transparent">
                    <v-stepper-header class="stepper-header-doctor">
                        <v-stepper-step :complete="steppers > 1" step="1" class="stepper" complete-icon="" :class="steppers == 1 ? 'medist-active-stepper' : '' ">
                            <small class="font-small primary--text" v-show="steppers == '1'">وارد کردن شماره همراه</small>
                        </v-stepper-step>
                        ...
                        <v-stepper-step :complete="steppers > 2" step="2" complete-icon="" :class="steppers == 2 ? 'medist-active-stepper' : '' ">
                            <small class="font-small primary--text" v-if="steppers == '2'">تایید کردن کد ارسالی</small>
                        </v-stepper-step>
                        ...
                        <v-stepper-step :complete="steppers > 3" step="3" complete-icon="" :class="steppers == 3 ? 'medist-active-stepper' : '' ">
                            <small class="font-small primary--text" v-if="steppers == '3'">اطلاعات شخصی</small>
                        </v-stepper-step>
                        ...
                        <v-stepper-step :complete="steppers > 4" step="4" complete-icon="" :class="steppers == 4 ? 'medist-active-stepper' : '' ">
                            <small class="font-small primary--text" v-if="steppers == '4'">اطلاعات تخصصی</small>
                        </v-stepper-step>
                            <v-divider :color="steppers >= 5 ? '#835ADE' : '' " class="medist-stepper-linear rounded-pill" />
                        <v-stepper-step :complete="steppers > 5 " step="5" :complete-icon="steppers > 5 ? 'mdi-check' : ''" :class="steppers == 5 ? 'medist-active-stepper' : '' ">
                            <small class="font-small primary--text" v-if="steppers == '5'">آپلود مدارک</small>
                        </v-stepper-step>
                            ...
                            <v-stepper-content step="1" class="stepper">
                                <div class="input-body">
                                    <div>
                                        ...
                                        <v-text-field :suffix="countryId" class="text-field" hide-details="" outlined flat placeholder="9121234567" />
                                    </div>
                                </div>
                            </v-stepper-content>
                ...
                <div class="action-bottoms-final" v-if="steppers == 5">
            ...
            <div v-if="steppers < 3" class="left hidden-sm-and-down">
