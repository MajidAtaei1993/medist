            ...
            <div class="table">
                ...
                <div class="data-table">
                        ...
                        <v-expansion-panels class="expansion-panels" flat v-model="expand">
                            <v-expansion-panel class="thead" v-for="(tr, i) in body.slice(0, 8)" :key="i">
                                <v-expansion-panel-header class="content">
                                    <img src="/assets/icons/admin/table/chat-tablet.png" alt="" class="chat-img ml-2 medist-cursor-pointer" @click="openChat = true">
                                    ...
                                    <div class="tbody">
                                        <div class="left">
                                            <div class="row">
                                                ...
                                                <div class="column">
                                                    <div class="text text-left">{{ tr.timeDate }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="right">
                                            <div class="row">
                                                ...
                                                <div class="column" v-for="(item, j) in header.slice(5, 6)" :key="j">
                                                    <img :src="item.iconTablet" alt="" class="img">
                                                    <div class="text">{{ item.text }}</div>
                                                </div>
                                            </div>
                    ...
                    <div class="windows-mode">
                        ...
                        <div class="tbody" style="max-height: 400px">
                            <div class="tr" v-for="(tr, i) in body" :key="i">
                                <div class="td">
                                    <img src="/assets/icons/admin/table/chat-g.png" alt="" class="ml-5 medist-cursor-pointer" @click="openChat = true">
                                    <div class="text">
                                        {{ tr.visitId }}</div>
                                </div>
                                <div class="td">
                                ...
                                <div class="td">
                                    <div class="text">{{ tr.timeDate }} __ {{ tr.timeDate1 }}</div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="medist-dashbaord-middle medist-chat-main" :class="width < 1024 ? 'medist-dashbaord-middle medist-chat-main' : 'medist-dashbaord-middle'" v-else>
            ...
            <div :style="width < 1024 && expand ? 'display: none' : ''" :class="selectedContact >= 0 ? 'chat-content' : 'empty-chat-content'" v-if="action == 'chating' || action =='minimizeVoiceCall' || action =='minimizeVideoCall'">
                ...
                <div class="chat-action" v-if="selectedContact >= 0">
                    <v-btn depressed class="deleteChat" v-if="chat.status == true">
                        <v-icon color="white">mdi-trash-can</v-icon>
                        پاک کردن چت
                    </v-btn>
                    <div class="end-chat" v-else>
                        <div class="text">چت خاتمه یافته</div>
                    </div>
                </div>
                <!-- end chat action -->
            </div>
    ...
    export default {
        ...
        data(){
            return{
                ...
                items:[
                    { text:'امروز', value:'0' },
                    { text:'چت های باز', value:'1' },
                    { text:'چت های بسته', value:'2' },
                    { text:'همه', value:'3' },
                ],
                headerMenu:[
                    { text:'امروز', value:0 },
                ...
                body:[
                    { visitId:'0123456789', doctorName:'سعید قادری', patientName:'مجید عطائی', patientPhone:'09198412978', patientTell:'09198412978', timeDate:'1400/12/06', timeDate1:'11:13 - 11:13', type:'چت تصویری', pay:'1.200.000 ريال' },
                    { visitId:'0123456789', doctorName:'سعید قادری', patientName:'مجید عطائی', patientPhone:'09198412978', patientTell:'09198412978', timeDate:'1400/12/06', timeDate1:'11:13 - 11:13', type:'مطب', pay:'1.200.000 ريال' },
                    { visitId:'0123456789', doctorName:'سعید قادری', patientName:'مجید عطائی', patientPhone:'09198412978', patientTell:'09198412978', timeDate:'1400/12/06', timeDate1:'11:13 - 11:13', type:'چت تصویری', pay:'1.200.000 ريال' },
                    { visitId:'0123456789', doctorName:'سعید قادری', patientName:'مجید عطائی', patientPhone:'09198412978', patientTell:'09198412978', timeDate:'1400/12/06', timeDate1:'11:13 - 11:13', type:'مطب', pay:'1.200.000 ريال' },
                    { visitId:'0123456789', doctorName:'سعید قادری', patientName:'مجید عطائی', patientPhone:'09198412978', patientTell:'09198412978', timeDate:'1400/12/06', timeDate1:'11:13 - 11:13', type:'چت تصویری', pay:'1.200.000 ريال' },
                    { visitId:'0123456789', doctorName:'سعید قادری', patientName:'مجید عطائی', patientPhone:'09198412978', patientTell:'09198412978', timeDate:'1400/12/06', timeDate1:'11:13 - 11:13', type:'مطب', pay:'1.200.000 ريال' },
