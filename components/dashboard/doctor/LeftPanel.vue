<template>
    <section class="user-left-panel">
        ...
        <div class="cards-tablet">
            <div class="card" v-for="(card, i) in cards1" :key="i">
                <img :src="card.img" class="img" alt="">
                <div class="text">
                    <div class="count">{{ card.count }}</div>
                    <div class="text">{{ card.text }}</div>
    ...
    export default {
        data(){
            return{
                ...
                cards:[
                    { img:'/assets/icons/doctor/list_of_thumbnails.png', count:'25', text:'نوبت های امروز' },
                    { img:'/assets/icons/doctor/protection_mask.png', count:'18', text:'تعداد بیماران امروز' }
                ],
                cards1:[
