<template>
    <section class="medist-dashbaord-middle">
        <div class="table" style="padding: 1.5%">
            <div class="notifs">
            ...
            <div class="data-table">
                ...
                <div class="windows-mode">
                    ...
                    <div class="cancel-section" style="height: 30px">
                    </div>
                </div>
                <!-- end windows size -->
            </div>
...
<script>
import LeftPanel from '../request-send/LeftPanel.vue'
    export default {
        ...
        data(){
            return{
                ...
                header: [
                    { iconTablet:'/assets/icons/doctor/barcode-c.png', icon:'/assets/icons/doctor/barcode-w.png', text: 'شناسه واریز', align: 'right' },
                    { iconTablet:'/assets/icons/doctor/protection_mask-b.png', icon:'/assets/icons/doctor/protection_mask-w.png', text: 'نام بیمار', align: 'right', value: 'docName' },
                    { iconTablet:'/assets/icons/patient/timer-c.png', icon:'/assets/icons/patient/timer.png', text: 'زمان شروع و پایان ویزیت', value: 'clock', align:'right' },
                    ...
                    { icon:'/assets/icons/doctor/tasklist-w.png', text: 'نوع ویزیت', value: 'type', align:'center' },
