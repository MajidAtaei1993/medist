<template>
    <section>
        <div class="medist-dashbaord-middle medist-chat-main" :class="width < 1024 ? 'medist-dashbaord-middle medist-chat-main' : 'medist-dashbaord-middle'">
            <!-- <span class="medist-middle-panel-chevron-icon-chat">
                <v-img :src="chevron" />
            </span> -->
            <!-- chat lists -->
                    ...
                    <div class="multimedia">
                        ...
                        <v-menu offset-y content-class="comment-menu" nudge-width="100%">
                            ...
                            <v-list color="white" class="list" dense>
                                <img src="/assets/icons/patient/comment.png" alt="">
                                <div class="text" @click="rateDialog = true">نظر دادن درباره پزشک</div>
                            </v-list>
                        </v-menu>
                    </div>
                </div>
                    ...
                    <v-list dense color="transparent" class="chat-main-list" v-if="selectedContact >= 0">
                        ...
                        <v-list-item dense>
                            ...
                            <v-col cols="auto" class="medist-chat-send-box">
                                <div class="text">سلام حالت چطوره چخبر چکارا میکنی ؟</div>
                                <div class="medist-chat-send-time-check-left">
                        ...
                        <v-list-item dense class="justify-end">
                            <v-col cols="auto" class="medist-chat-receive-box">
                                ...
                                <div class="medist-chat-send-time-check-right">
                        ...
                        <v-list-item dense>
                            ...
                            <v-col cols="auto" class="medist-chat-send-box">
                                <div class="d-flex align-center w-100">
                                    <v-btn fab x-small color="white" depressed class="ml-2" @click="play =! play">
                                        <v-icon color="primary">{{ play ? 'mdi-play' : 'mdi-stop'}}</v-icon>
                                    </v-btn>
                                    <v-slider hide-details min="-100" max="0" class="slider" thumb-color="white" track-fill-color="white" track-color="white" />
                                    <small class="white--text">03:00</small>
                                </div>
                                <div class="medist-chat-send-time-check-left">
                        ...
                        <v-list-item dense class="justify-end">
                            <v-col cols="auto" class="medist-chat-receive-box">
                                <div class="d-flex align-center">
                                    <small class="info--text ml-1">03:00</small>
                                    <v-slider hide-details min="-100" max="0" class="slider" thumb-color="primary" track-fill-color="primary" track-color="primary" />
                                    <v-btn fab x-small color="primary" depressed @click="play =! play">
                                        <v-icon>{{ play ? 'mdi-play' : 'mdi-stop'}}</v-icon>
                                    </v-btn>
                                </div>
                                <div class="medist-chat-send-time-check-right">
                        ...
                        <v-list-item dense class="justify-end">
                            <v-col cols="auto" class="medist-chat-receive-box">
                                ...
                                <div class="medist-chat-send-time-check-right w-100">
                                    <v-icon color="primary" x-small>mdi-check</v-icon>
                                    <small>17:00</small>
                                </div>
                            </v-col>
